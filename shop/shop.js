let score = isNaN(parseFloat(localStorage.getItem('scores'))) ? 0 : parseFloat(localStorage.getItem('scores'));
let scoreText = document.getElementById('crystal-count');
